...
const CustomizeProducts = ({
    ...
    return (
        ...
        <ul className='flex items-center gap-3'>
            <li className='ring-1 ring-bb text-bb rounded-md py-1 px-4 text-sm cursor-pointer'>
                Small
            </li>
            <li className='ring-1 ring-bb text-white bg-bb rounded-md py-1 px-4 text-sm cursor-pointer'>
                Medium
            </li>
